...
const studentRoutes = require("./src/controllers/studentController");
...
// Rota que cria aluno
app.post("/create", studentRoutes.createStudent);

// Rota que deleta um aluno
app.delete("/delete/:id", studentRoutes.deleteStudent);
